					...
					{teamMembers.map(member => (
						<div
							...
							className="
								w-full
								max-w-xs
								sm:max-w-[320px] md:max-w-[270px] lg:max-w-[280px]
								h-[340px]
						...
						>
							...
							<div
								className={`
									flex flex-col absolute left-4 bottom-4 z-10
									transition-all duration-300
							...
							>
								<h1 className="font-[regular] text-[1.1rem] sm:text-[1.2rem] md:text-[1.1rem] lg:text-[1.25rem] text-white">{member.name}</h1>
								<h2 className="text-[0.95rem] sm:text-[1.05rem] md:text-[1rem] text-white">{member.title}</h2>
							</div>
						</div>
					))}
				</div>
