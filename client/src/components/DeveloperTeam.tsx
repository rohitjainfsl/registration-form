...
import { Code2, Layers, Globe, Sparkles, ArrowUpRight, Github, Linkedin, Mail } from "lucide-react";

const devs = [
	{
		name: "Rohit Jain",
		image: "/images/RohitSir.jpg",
...
<span style={{ fontSize: size * 0.35 }} className="text-primary-foreground">
{initials}
</span>
)}
...
return (
<button className="w-9 h-9 rounded-xl border border-border/30 bg-white/6 hover:gradient-brand hover:text-primary-foreground flex items-center justify-center text-muted-foreground transition-all duration-300">
